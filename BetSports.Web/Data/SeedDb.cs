...
namespace BetSports.Web.Data
{
    public class SeedDb
    {
            ...
            string address)
        {
            ...
            {
                _dataContext.Companies.Add(new Entities.Company {
                    IdType = idType, 
                    Name = name, 
                    Address = address,
                    Status = true
        ...
        {
            if (!_dataContext.Bankings.Any())
            {
                _dataContext.Languages.Add(new Entities.Language { Name = "English", Status = true });
                _dataContext.Languages.Add(new Entities.Language { Name = "Spanish", Status = true });
                await _dataContext.SaveChangesAsync();
            }
        }
        ...
        private async Task CheckLeagueAsync()
        {
            ...
            {
                _dataContext.Leagues.Add(new Entities.League { Name = "Liga Dominicana de Béisbol", Status = true });
                _dataContext.Leagues.Add(new Entities.League { Name = "Argentina Copa Argentina", Status = true });
                _dataContext.Leagues.Add(new Entities.League { Name = "Argentina Primera División", Status = true });
                _dataContext.Leagues.Add(new Entities.League { Name = "Baseball Players", Status = true });
                _dataContext.Leagues.Add(new Entities.League { Name = "Belgium Jupiler League", Status = true });
                _dataContext.Leagues.Add(new Entities.League { Name = "Boxing League", Status = true });
                _dataContext.Leagues.Add(new Entities.League { Name = "Brazil Copa Do Brasil", Status = true });
                _dataContext.Leagues.Add(new Entities.League { Name = "Brazil Serie A", Status = true });
                _dataContext.Leagues.Add(new Entities.League { Name = "CONCACAF Champions League", Status = true });
                _dataContext.Leagues.Add(new Entities.League { Name = "Canadian Football League", Status = true });
                _dataContext.Leagues.Add(new Entities.League { Name = "Caribbean Baseball League", Status = true });
                _dataContext.Leagues.Add(new Entities.League { Name = "Copa Libertadores", Status = true });
                _dataContext.Leagues.Add(new Entities.League { Name = "Copa Sudamericana", Status = true });
                _dataContext.Leagues.Add(new Entities.League { Name = "Coppa Italia", Status = true });
                _dataContext.Leagues.Add(new Entities.League { Name = "England", Status = true });
                _dataContext.Leagues.Add(new Entities.League { Name = "FIFA", Status = true });
                _dataContext.Leagues.Add(new Entities.League { Name = "FIFA Confederations Cup", Status = true });
                _dataContext.Leagues.Add(new Entities.League { Name = "France Coupe", Status = true });
                _dataContext.Leagues.Add(new Entities.League { Name = "France Ligue 1", Status = true });
                _dataContext.Leagues.Add(new Entities.League { Name = "Germany Bundesliga", Status = true });
                _dataContext.Leagues.Add(new Entities.League { Name = "Italy Serie A", Status = true });
                _dataContext.Leagues.Add(new Entities.League { Name = "Liga Mexicana de Beisbol", Status = true });
                _dataContext.Leagues.Add(new Entities.League { Name = "Liga Mexicana del Pacifico", Status = true });
                _dataContext.Leagues.Add(new Entities.League { Name = "Liga Venezonala de Béisbol Profesional", Status = true });
                _dataContext.Leagues.Add(new Entities.League { Name = "Major League Soccer", Status = true });
                _dataContext.Leagues.Add(new Entities.League { Name = "Mexico Copa MX", Status = true });
                _dataContext.Leagues.Add(new Entities.League { Name = "Mexico Primera División", Status = true });
                _dataContext.Leagues.Add(new Entities.League { Name = "NBA MatchUps", Status = true });
                _dataContext.Leagues.Add(new Entities.League { Name = "NBA Solo", Status = true });
                _dataContext.Leagues.Add(new Entities.League { Name = "NFL Solo", Status = true });
                _dataContext.Leagues.Add(new Entities.League { Name = "National Basketball Association", Status = true });
                _dataContext.Leagues.Add(new Entities.League { Name = "National College Basketball Association", Status = true });
                _dataContext.Leagues.Add(new Entities.League { Name = "National Collegiate Athletic Association Football", Status = true });
                _dataContext.Leagues.Add(new Entities.League { Name = "National Football League", Status = true });
                _dataContext.Leagues.Add(new Entities.League { Name = "Netherlands Eredivisie", Status = true });
                _dataContext.Leagues.Add(new Entities.League { Name = "Portugal Primeira Liga", Status = true });
                _dataContext.Leagues.Add(new Entities.League { Name = "Russia Premier League", Status = true });
                _dataContext.Leagues.Add(new Entities.League { Name = "Spain Copa del Rey", Status = true });
                _dataContext.Leagues.Add(new Entities.League { Name = "Spain La Liga", Status = true });
                _dataContext.Leagues.Add(new Entities.League { Name = "Turkey Super Lig", Status = true });
                _dataContext.Leagues.Add(new Entities.League { Name = "Turkish Airlines Euroleague", Status = true });
                _dataContext.Leagues.Add(new Entities.League { Name = "UEFA Champion League", Status = true });
                _dataContext.Leagues.Add(new Entities.League { Name = "Womens National Basketball Association", Status = true });
                _dataContext.Leagues.Add(new Entities.League { Name = "World Cup", Status = true });
                await _dataContext.SaveChangesAsync();
            }
        }
        ...
        {
            if (!_dataContext.TypePlays.Any())
            {
                _dataContext.TypePlays.Add(new Entities.TypePlay { Name = "Primera mitad", Status = true });
                _dataContext.TypePlays.Add(new Entities.TypePlay { Name = "Primera mitad a mas", Status = true });
                _dataContext.TypePlays.Add(new Entities.TypePlay { Name = "Primera mitad a menos", Status = true });
                _dataContext.TypePlays.Add(new Entities.TypePlay { Name = "Solo en primera mitad a mas", Status = true });
                _dataContext.TypePlays.Add(new Entities.TypePlay { Name = "Solo en primera mitad a menos", Status = true });
                _dataContext.TypePlays.Add(new Entities.TypePlay { Name = "Juego Completo", Status = true });
                _dataContext.TypePlays.Add(new Entities.TypePlay { Name = "Run Line", Status = true });
                _dataContext.TypePlays.Add(new Entities.TypePlay { Name = "Juego a mas", Status = true });
                _dataContext.TypePlays.Add(new Entities.TypePlay { Name = "Juego a menos", Status = true });
                _dataContext.TypePlays.Add(new Entities.TypePlay { Name = "Equipo solo a mas", Status = true });
                _dataContext.TypePlays.Add(new Entities.TypePlay { Name = "Equipo solo a menos", Status = true });
                _dataContext.TypePlays.Add(new Entities.TypePlay { Name = "Super Run Line", Status = true });
                _dataContext.TypePlays.Add(new Entities.TypePlay { Name = "Pitcher ponches a mas", Status = true });
                _dataContext.TypePlays.Add(new Entities.TypePlay { Name = "Pitcher ponches a menos", Status = true });
                _dataContext.TypePlays.Add(new Entities.TypePlay { Name = "Run Line alternativo", Status = true });
                _dataContext.TypePlays.Add(new Entities.TypePlay { Name = "Sancocho(RHE) a mas", Status = true });
                _dataContext.TypePlays.Add(new Entities.TypePlay { Name = "Sancocho(RHE) a menos", Status = true });
                _dataContext.TypePlays.Add(new Entities.TypePlay { Name = "Periodo #1", Status = true });
                _dataContext.TypePlays.Add(new Entities.TypePlay { Name = "Periodo #1 a mas", Status = true });
                _dataContext.TypePlays.Add(new Entities.TypePlay { Name = "Periodo #1 a menos", Status = true });
                _dataContext.TypePlays.Add(new Entities.TypePlay { Name = "Periodo #1 equipo solo a mas", Status = true });
                _dataContext.TypePlays.Add(new Entities.TypePlay { Name = "Periodo #1 equipo solo a menos", Status = true });
                _dataContext.TypePlays.Add(new Entities.TypePlay { Name = "Periodo #2", Status = true });
                _dataContext.TypePlays.Add(new Entities.TypePlay { Name = "Periodo #2 a mas", Status = true });
                _dataContext.TypePlays.Add(new Entities.TypePlay { Name = "Periodo #2 a menos", Status = true });
                _dataContext.TypePlays.Add(new Entities.TypePlay { Name = "Periodo #3", Status = true });
                _dataContext.TypePlays.Add(new Entities.TypePlay { Name = "Periodo #3 a mas", Status = true });
                _dataContext.TypePlays.Add(new Entities.TypePlay { Name = "Periodo #3 a menos", Status = true });
                _dataContext.TypePlays.Add(new Entities.TypePlay { Name = "Periodo #4", Status = true });
                _dataContext.TypePlays.Add(new Entities.TypePlay { Name = "Periodo #4 a mas", Status = true });
                _dataContext.TypePlays.Add(new Entities.TypePlay { Name = "Periodo #4 a menos", Status = true });
                _dataContext.TypePlays.Add(new Entities.TypePlay { Name = "Periodo #4 equipo solo a mas", Status = true });
                _dataContext.TypePlays.Add(new Entities.TypePlay { Name = "Periodo #4 equipo solo a menos", Status = true });
                _dataContext.TypePlays.Add(new Entities.TypePlay { Name = "Segunda mitad", Status = true });
                _dataContext.TypePlays.Add(new Entities.TypePlay { Name = "Segunda mitad a mas", Status = true });
                _dataContext.TypePlays.Add(new Entities.TypePlay { Name = "Segunda mitad a menos", Status = true });
                _dataContext.TypePlays.Add(new Entities.TypePlay { Name = "Solo en segunda mitad a mas", Status = true });
                _dataContext.TypePlays.Add(new Entities.TypePlay { Name = "Solo en segunda mitad a menos", Status = true });
                _dataContext.TypePlays.Add(new Entities.TypePlay { Name = "Primera tercia", Status = true });
                _dataContext.TypePlays.Add(new Entities.TypePlay { Name = "Primera tercia a mas", Status = true });
                _dataContext.TypePlays.Add(new Entities.TypePlay { Name = "Primera tercia a menos", Status = true });
                await _dataContext.SaveChangesAsync();
            }
        }

        private async Task CheckBanckingAsync()
        {
            if (!_dataContext.Bankings.Any())
            {
                _dataContext.Bankings.Add(new Entities.Banking
                {
                    //IdType = 1,
                    Document ="1-01-0001",
                    Name = "Banking",
